...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, COMPUTER ENGINEERING DEPARTMENT, JIT</h3>
        </div>
    </div>
</div>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4>India - 202 002</h4>
                <h4><strong>Call:</strong> 8827893 </h4>
                <h4><strong>Email: </strong>hello@hello.com</h4>
            </div>
